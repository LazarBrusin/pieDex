...
import { Layout, Tabs, Button, Card, Image, Input, InputNumber } from "antd";
      ...
      <Router>
        ...
        <div style={styles.content}>
          <Switch>
            ...
            <Route path="/1inch">
              <Tabs defaultActiveKey="0" style={{ alignItems: "center" }}>
                <Tabs.TabPane tab={<span>Swap Guide</span>} key="0">
                  <Card style={styles.card} bodyStyle={{ padding: "18px" }}>
                    ...
                    >
                      <div
                        style={{ marginBottom: "5px", fontSize: "20px", color: "#434343" }}
                      >
                        Swap Guide
                      ...
                      >
                        <div>
                          <Text style={{ fontWeight: "600", color: "#434343", fontWeight: '500' }}>
                            <p style={{ fontSize: '16px' }}>1. Connect Wallet </p>
                            <p style={{ fontSize: '16px' }}>2. Select Network (ETH, BSC, POLY)</p>
                            <p style={{ fontSize: '16px' }}>3. Select tokens. First select the token you wish to swap and the token you wish to receive. ...</p>
                            <p style={{ fontSize: '16px' }}>4. Enter the input amount and click swap btn</p>
                          </Text>
                        </div>
                      </div>
                    </Card>
...
export const Logo = () => (
  <div style={{ display: "flex" }}>
    <img src="pieDexLogo/PieDexLogoHiResB.png" style={{ width: '200px', height: '50px' }} />
    {/* <svg
      width="60"
      height="38"
      viewBox="0 0 50 38"
